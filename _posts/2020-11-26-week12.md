...
![Accuracy](files/Accuracy_For_Binary_Brain_Age_Classification_CNN.png)

![AUC](files/Area_Under_Curve_For_Binary_Brain_Age_Classification.png)

![Binary Cross Entropy Loss](files/Binary_Cross_Entropy_Loss_for_Binary_Brain_Age_Classification_CNN.png)

![Precision](files/Precision_For_Binary_Brain_Age_Classification.png)

![Recall](files/Recall_For_Binary_Brain_Age_Classification.png)
